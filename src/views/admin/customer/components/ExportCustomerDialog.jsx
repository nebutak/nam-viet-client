...
import ExportCustomerView from './ExportCustomerView'

const ExportCustomerDialog = ({
  open,
  onOpenChange,
  showTrigger = true,
  ...props
  ...
  const handleReviewExport = async () => {
    ...
    try {
      ...
      if (!customers.length) {
        toast.warning('Danh sách khách hàng trống')
        return
      }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} {...props}>
      ...
      <DialogContent className="md:h-auto md:w-[320px] z-[100095]" overlayClassName="z-[100094]">
        <DialogHeader>
          <DialogTitle>Xuất báo cáo khách hàng</DialogTitle>
          <DialogDescription>
...
export default ExportCustomerDialog
