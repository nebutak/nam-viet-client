...
import ExportUnitView from './ExportUnitView'

const ExportUnitDialog = ({
  open,
  onOpenChange,
  showTrigger = true,
  ...props
  ...
  const handleReviewExport = async () => {
    ...
    try {
      ...
      if (!units.length) {
        toast.warning('Danh sách đơn vị trống')
        return
      }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} {...props}>
      ...
      <DialogContent className="md:h-auto md:w-[320px] z-[100095]" overlayClassName="z-[100094]">
        <DialogHeader>
          <DialogTitle>Xuất báo cáo đơn vị</DialogTitle>
          <DialogDescription>
...
export default ExportUnitDialog
