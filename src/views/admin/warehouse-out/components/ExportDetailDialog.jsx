...
const dateFormat = (d) => d ? new Date(d).toLocaleDateString('vi-VN') : '—'
...
export function ExportDetailDialog({ transaction, open, onOpenChange }) {
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 rounded-lg border p-3 bg-muted/30">
                        ...
                        <div>
                            ...
                            {transaction.referenceId && (
                                <InfoRow label="Đơn hàng" value={`#${transaction.referenceId}`} />
                            )}
                        </div>
                    </div>
                    ...
                    {transaction.reason && (
                        <div className="rounded-md border px-3 py-2 bg-muted/20">
                            <p className="text-xs text-muted-foreground mb-1">Lý do xuất kho</p>
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-muted/50">
                                    <tr>
                                        ...
                                        <th className="px-3 py-2 text-right font-medium">SL xuất</th>
                                ...
                                <tbody>
                                    {details.map((d, idx) => (
                                        <tr key={idx} className="border-t">
                                            ...
                                            <td className="px-3 py-2 text-right">{formatCurrency(d.unitPrice)}</td>
                                ...
                                <tfoot className="bg-muted/30">
                                    <tr className="border-t font-semibold">
                                        ...
                                        <td className="px-3 py-2 text-right text-primary">{formatCurrency(totalValue)}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
