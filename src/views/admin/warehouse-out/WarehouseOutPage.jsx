...
import { WarehouseOutDataTable } from './components/WarehouseOutDataTable'
            ...
            <LayoutBody className="flex flex-col" fixedHeight>
                <div className="mb-2 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Quản lý phiếu xuất hàng khỏi kho</p>
                    </div>
                </div>
                <div className="-mx-4 flex-1 overflow-hidden px-4 py-1">
                    <WarehouseOutDataTable
                        data={transactions}
                        columns={columns}
                        loading={loading}
