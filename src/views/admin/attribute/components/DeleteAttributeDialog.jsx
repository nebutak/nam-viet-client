...
import { deleteAttribute } from '@/stores/AttributeSlice'
import { TrashIcon } from '@radix-ui/react-icons'
import { useDispatch, useSelector } from 'react-redux'

const DeleteUnitDialog = ({ attribute, showTrigger = true, ...props }) => {
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <strong>{attribute.name}</strong> sẽ bị xóa
          </DialogDescription>
        </DialogHeader>
