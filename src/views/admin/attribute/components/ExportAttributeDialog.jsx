...
import ExportAttributeView from './ExportAttributeView'

const ExportAttributeDialog = ({
  open,
  onOpenChange,
  showTrigger = true,
  ...props
  ...
  const handleReviewExport = async () => {
    ...
    try {
      ...
      if (!attributes.length) {
        toast.warning('Danh sách thuộc tính trống')
        return
      }

      setExportData(attributes)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} {...props}>
      ...
      <DialogContent className="md:h-auto md:w-[320px] z-[100095]" overlayClassName="z-[100094]">
        <DialogHeader>
          <DialogTitle>Xuất báo cáo thuộc tính</DialogTitle>
          <DialogDescription>
...
export default ExportAttributeDialog
