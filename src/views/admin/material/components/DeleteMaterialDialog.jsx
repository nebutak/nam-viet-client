...
import { deleteMaterial } from '@/stores/MaterialSlice'
import { TrashIcon } from '@radix-ui/react-icons'
import { useDispatch, useSelector } from 'react-redux'

const DeleteMaterialDialog = ({ material, showTrigger = true, contentClassName, overlayClassName, ...props }) => {
        ...
        <Dialog {...props}>
            ...
            <DialogContent className={contentClassName} overlayClassName={overlayClassName}>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Hành động này không thể hoàn tác. Nguyên liệu:{' '}
                        <strong>{material?.name}</strong> sẽ bị xóa khỏi hệ thống.
                    </DialogDescription>
                </DialogHeader>
