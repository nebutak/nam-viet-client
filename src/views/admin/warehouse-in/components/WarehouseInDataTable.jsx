...
import { WarehouseInToolbar } from './WarehouseInToolbar'
import { DataTablePagination } from '../../customer/components/DataTablePagination'
import { Loader2 } from 'lucide-react'

export function WarehouseInDataTable({
    data,
    columns,
    loading,
    pagination,
    ...
    const table = useReactTable({
        data,
        columns,
        state: { columnVisibility, rowSelection, columnFilters, globalFilter, pagination },
        pageCount,
        rowCount,
