...
const ProductDataTable = ({ columns, data, type = 'PRODUCT', loading = false, hideCreateProduct = false }) => {
  ...
  if (!isDesktop) {
    return (
      <div className="space-y-4">
        <DataTableToolbar table={table} type={type} hideCreateProduct={hideCreateProduct} />
