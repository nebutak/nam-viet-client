...
import ExportTaxView from './ExportTaxView'

const ExportTaxDialog = ({
  open,
  onOpenChange,
  showTrigger = true,
  ...props
  ...
  const handleReviewExport = async () => {
    ...
    try {
      ...
      const taxes = data.data?.data || data.data || []

      if (!taxes.length) {
        toast.warning('Danh sách thuế trống')
        return
      }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} {...props}>
      ...
      <DialogContent className="md:h-auto md:w-[320px] z-[100095]" overlayClassName="z-[100094]">
        <DialogHeader>
          <DialogTitle>Xuất báo cáo thuế</DialogTitle>
          <DialogDescription>
...
export default ExportTaxDialog
